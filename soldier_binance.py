# ================================================================
# HORUS BINANCE SOLDIER (Async)
# ================================================================
#  الجندي الخاص ببورصة BINANCE
#  يرث من SoldierBase
...
log = logging.getLogger("SoldierBinance")


class SoldierBinance(SoldierBase):
    """
    Soldier for Binance customers.
    الوظائف:
      - توحيد symbol format من BTC/USDT → BTCUSDT
      - تنفيذ Buy/Sell/Close عبر SoldierBase
    """

    def __init__(self, user_id):
        super().__init__(user_id, exchange="binance")
